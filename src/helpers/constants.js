...
export const ENDPOINT = deploy === "development" ? process.env.NEXT_PUBLIC_API_ENDPOINT_DEVELOPMENT : process.env.NEXT_PUBLIC_API_ENDPOINT_PRODUCTION
...
export const URL = deploy === "development" ? process.env.NEXT_PUBLIC_REACT_BASE_URL_DEVELOPMENT :  process.env.NEXT_PUBLIC_REACT_BASE_URL_PRODUCTION